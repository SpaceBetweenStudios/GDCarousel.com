  ...
  <div class="row row-cols-1 g-3 mb-5">
    ...
    <div class="col">
      <div class="row justify-content-between">
        <div class="col-12 col-sm-8">
          ...
          <p>
            I'm <a href="https://seg.fyi/" target="_blank">John "Seg" Seggerson</a>, a former game developer and now an experience designer for immersive / themed entertainment. With a donation to the <a href="https://creativity.org/" target="_blank">The Children's Creativity Museum</a>, I am sponsoring the operation of the <a href="https://creativity.org/carousel/" target="_blank">LeRoy King Carousel</a> for the day.
          </p>
          <p>
    ...
    <div class="col">
      ...
      <div class="row justify-content-between">
        <div class="col">
          <p>
            The carousel is now operated by Yerba Buena Gardens Conservancy. The <a href="https://creativity.org/" target="_blank">Children's Creativity Museum</a> is currently subcontracted to provide ride operators.
          </p>
        </div>
        <div class="col-auto">
    ...
    <div class="col">
      ...
      <div class="row justify-content-between">
        <div class="col">
          <p>
            The LeRoy King is a carousel by <a href="https://en.wikipedia.org/wiki/Charles_I._D._Looff" target="_blank">Charles I.D. Looff</a> and is one of over 40 carousels he created in his lifetime. He is credited for created the Coney Island style of carousel, characterized as flamboyant horses with jewels and gold or silver leaf.
          </p>
          <p>
            First commissioned to be installed at Steeplechase Park in San Francisco, the 1906 earthquake disrupted the planned installation. Instead, Looff later installed the carousel an amusement park he built in Seattle: <a href="https://www.historylink.org/File/1390" target="_blank">Luna Park</a>. After a fire occurred at Luna Park in 1913, the undamaged carousel was relocated to <a href="https://www.sfchronicle.com/projects/2022/visuals/playland-at-the-beach/" target="_blank">San Francisco's Playland at the Beach</a>.
          </p>
          <p>
            When Playland closed in 1972, it was sold to carousel collector and restorer <a href="https://carouselhistory.com/marianne-stevens-jan-1929-sept-2012/" target="_blank">Marianne Stevens</a>. After storing the carousel in New Mexico for a few years, the carousel would operate from 1982 to 1998 under lease to Shoreline Village in Long Beach, CA.
          </p>
          <p>
            In 1994, the City of San Francisco purchased the carousel and in the summer of 1998 returned to San Francisco at it's current location at Yerba Buena Gardens. In 2014, the carousel was refurbished and dedicated to San Francisco Redevelopment commissioner <a href="https://usfblogs.usfca.edu/sfchangemakers/2020/07/03/leroy-king/" target="_blank">LeRoy King</a>.
          </p>
        </div>
      </div>
    </div>
